...
ggplot(names_plot, aes(x = Rank , y = Count)) + geom_point(aes(), alpha = 0.5) # scatter plot showing the number of children with a name against the rank in popularity of that name
